          ...
          <WhiteContainer>
            <div className="px-6 md:px-10 py-8 md:py-12 space-y-6 text-brand-dark-gray">
              ...
              <h2 id="m716">Präambel</h2>
                ...
                <p>
                    E-Mail-Adresse:{" "}
                    <a href="mailto:sergej@lebensthema.coach">sergej@lebensthema.coach</a>
                </p>
                <p>
                    Impressum:{" "}
                    <a href="https://lebensthema.coach/impressum" target="_blank">
                    https://lebensthema.coach/impressum
                    </a>
                </p>
                ...
                <ul className="m-elements">
                    ...
                    Kontaktformular, per E-Mail oder anderen Kommunikationswegen, verarbeiten
                    wir die uns übermittelten personenbezogenen Daten zur Beantwortung und
                    Bearbeitung des jeweiligen Anliegens. Dies umfasst in der Regel Angaben
                    wie Name, Kontaktinformationen und gegebenenfalls weitere Informationen,
                    die uns mitgeteilt werden und zur angemessenen Bearbeitung erforderlich
                ...
                <p>
                    Wir nutzen Hosting-Angebote von Dienstanbietern, um unsere Audio-Inhalte zum
                    Anhören und zum Download anzubieten. Dabei setzen wir Plattformen ein, die
                    das Hochladen, Speichern und Verbreiten von Audio-Material ermöglichen.
                </p>
                <ul className="m-elements">
                    <li>
                    <strong>Verarbeitete Datenarten:</strong> Nutzungsdaten (z. B.
                ...
                <ul className="m-elements">
                    <li>
                    <strong>Spotify: </strong>Podcast-Hosting, Veröffentlichung und Verwaltung
                    von Podcast-Inhalten, Analyse von Hörverhalten und Statistiken,
                    Monetarisierungsoptionen für Podcaster; <strong>Dienstanbieter:</strong>{" "}
                ...
                <ul className="m-elements">
                    ...
                    ; <strong>Sicherheitsmaßnahmen:</strong> IP-Masking (Pseudonymisierung der
                    IP-Adresse); <strong>Datenschutzerklärung:</strong>{" "}
                ...
                <p>
                    ...
                    Anspruch genommene Leistung an die jeweilige Bewertungsplattform
                ...
                <ul className="m-elements">
                    ...
                    innerhalb unseres Onlineangebotes dargestellt, er wird aber in diesem
                    Moment von den Servern des jeweiligen Widgets-Anbieters abgerufen. Nur so
                    kann immer der aktuelle Inhalt gezeigt werden, vor allem die jeweils
                ...
                <ul className="m-elements">
                    ...
                    <li>
                    <strong>Pinterest: </strong>Soziales Netzwerk, ermöglicht das Teilen von
                    Fotos, Kommentieren, Favorisieren und Kuratieren von Beiträgen,
                    Nachrichtenversand, Abonnieren von Profilen;{" "}
                    <strong>Dienstanbieter:</strong> Pinterest Europe Limited, 2nd Floor,
                ...
                <ul className="m-elements">
                    ...
                    ; <strong>Grundlage Drittlandtransfers:</strong> Data Privacy Framework
                    (DPF). <strong>Widerspruchsmöglichkeit (Opt-Out):</strong> Opt-Out-Plugin:{" "}
                    <a href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank">
                        https://tools.google.com/dlpage/gaoptout?hl=de
                    </a>
                    , Einstellungen für die Darstellung von Werbeeinblendungen:{" "}
