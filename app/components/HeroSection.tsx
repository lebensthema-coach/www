        ...
        <div className="px-6 md:px-10 py-8 md:py-12 text-center">
          ...
          <div className="mb-8 md:mb-10">
            <h2 className="text-brand-dark-gray text-xl md:text-2xl lg:text-3xl font-semibold leading-relaxed text-center tracking-tight max-w-3xl mx-auto">
              Erkenne Dein Lebensthema – befreie Dich aus alten Mustern
            </h2>
          </div>
          ...
          <div className="text-center">
            <Button href="https://calendly.com/lebensthema/coach" target="_blank" rel="noopener noreferrer">
              Jetzt Termin sichern und sofort buchen
            </Button>
          </div>
        </div>
      </WhiteContainer>
